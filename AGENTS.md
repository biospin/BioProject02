...
> 버전: v0.5 | 작성: 2026-05-16 braveji (ykji) | 최종 수정: 2026-06-12
...
|---|---|---|---|---|
| braveji | 지용기 | Orchestrator + Scientific Critic + 프로젝트 리더 | 2205 | `/workspace/agents/orchestrator/` |
| gglee   | 이건규 | Scientific Critic (보조) | 2203 | `/workspace/agents/critic/` |
...
**분담 원칙:** braveji가 Orchestrator + Critic + 리더 겸임 (2026-06-12 변경). 나머지 1인 1역할.
...
| **MLflow** | 실험 레지스트리 + 모델 비교 UI (셀프호스팅) | `MLFLOW_TRACKING_URI=http://61.109.239.220:5000` |
...
| v0.5 | 2026-06-12 | braveji Orchestrator + Scientific Critic + 프로젝트 리더 겸임으로 변경 |
