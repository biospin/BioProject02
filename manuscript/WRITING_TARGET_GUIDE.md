...
> ⚠️ **현재 제출처는 ML4H 2026 (NeurIPS 워크숍)이다** — [`VENUE.md`](VENUE.md).
> 이 문서는 npj Precision Oncology 게재 논문 분석이라 **형식·분량 근거로는 쓰지 않는다.**
> 논증 구조·표·그림에 대한 관찰은 벤뉴와 무관하게 유효하다. 후속 저널 투고를 결정하면 형식 부분도 그대로 쓴다.
