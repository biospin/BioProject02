...
| **Fig 2** ⭐ | label↔therapy 해리 2-panel (**최결정 그림**) | 🔄 부분 — cost 그림 존재, 2-panel(confusion×distance) 미확정 | `experiments/kkkim/20260710_cost_of_substitution/make_fig_cost.py` → `fig_cost_of_substitution.png` | kkkim/sjpark | BIOP02-91 |
...
## 남은 작업
- Fig 2(최결정) 2-panel 확정 — kkkim/sjpark (BIOP02-91).
