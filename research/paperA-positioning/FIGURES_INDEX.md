...
| **Fig 3** | 축별 cost + headline 대비 (cost bar + CI) | 🔄 부분 — cost_of_substitution 그림에 포함, 분리 산출 필요 | (위 cost 스크립트) | kkkim/sjpark | BIOP02-91 |
...
## 남은 작업
- ~~Fig 2(최결정) 2-panel 확정~~ → 초안 완료(kkkim, 2026-07-15). 잔여: 근거 JSON critic_status pending → Critic 서명 필요, Fig 3(축별 cost 막대) 분리 산출 아직 미착수.
