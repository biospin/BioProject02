...
- **서버(현행):** RTX A6000 49GB × 3, 32 vCPU, RAM 503 GiB — `121.126.38.195`, SSH 키 전용 (컨테이너 환경). 기존 `61.109.239.220`(A100 80GB × 1, 24코어/188GiB)은 현재 사용 불가. (kkkim 포트=2205, 나머지 재확인 필요)
